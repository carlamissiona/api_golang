...
func data_todb(db *db.Adapter) {
	...
	if err != nil {
		...
		db.Execute(`COPY covid_observations(SNo,ObservationDate,ProvinceState,CountryRegion,LastUpdate,Confirmed,Deaths,Recovered) FROM 'data.csv' DELIMITER ',' CSV HEADER;`)
